...
import static com.app_republic.shoot.activity.SplashActivity.SETTINGS_TITLE;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
     ...
     */
    private void sendNotification(Map<String, String> data, String messageBody, Uri image) {
        Intent intent;
